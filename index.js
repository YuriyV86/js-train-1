...
function getDayOfWeek(dayNumber) {
  ...
  let dayNumberName;
  switch (dayNumber) {
    case 1 : dayNumberName = 'Понеділок'; break;
    case 2 : dayNumberName = 'Вівторок'; break;
    case 3 : dayNumberName = 'Середа'; break;
    case 4 : dayNumberName = 'Четвер'; break;
    case 5 : dayNumberName = "П'ятниця"; break;
    case 6 : dayNumberName = 'Субота'; break;
    case 7 : dayNumberName = 'Неділя'; break;
    default: dayNumberName = 'Невірний номер дня';
  }
...
function getVariableType(variable) {
  ...
  return (varType == 'number') ? 'Це число' : (varType == 'string') ? 'Це рядок' : (varType == 'boolean') ? 'Це булеве значення' : 'Це інший тип';
}
...
function memoizedArea() {
  ...
  return (side) => {
    if (side === prevSide) {
      return (
        console.log(`Fetching from cache`), prevResult);
      // return prevResult;
    }
